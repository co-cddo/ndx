...
- Added **/*.mjs to ignores to exclude the config file itself from TypeScript linting
...
- Ignore patterns complete (node_modules, cdk.out, *.js, *.d.ts, *.mjs, coverage) ✓
...
| AC4 | Ignores include node_modules, cdk.out, cdk.context.json, *.js, coverage | IMPLEMENTED | **File:** infra/eslint.config.mjs lines 7-14 (ignores array includes: node_modules/**, cdk.out/**, cdk.context.json, **/*.js, **/*.d.ts, **/*.mjs, coverage/**) - all 5 required patterns present plus **/*.d.ts and **/*.mjs for completeness |
...
- ✅ Generated files excluded from linting (*.js, *.d.ts, *.mjs)
