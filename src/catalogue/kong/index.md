...
description: Enterprise-grade API Gateway and Service Mesh platform that enables secure, reliable, and scalable API and micro-services communication for government organisations.
image:
  src: /assets/catalogue/kong/kong-logo.svg
...
Kong is a leading API Gateway and Service Mesh platform that helps government organisations secure, manage, and scale their APIs and micro-services. It provides essential capabilities for digital transformation initiatives in the public sector, including robust security features, comprehensive monitoring, and flexible deployment options.

## Key features

### Advanced security and access control

- **Authentication and authorisation**: Support for multiple authentication methods including OAuth2, JWT, and OIDC
...
- Reduce development time through standardised API management
- Lower operational costs through automation
- Optimise resource usage with intelligent caching

### Compliance and audit

- Detailed audit logs for all API transactions
- Support for compliance requirements (GDPR and other standards)
- Role-based access control for administrative functions

## Key benefits for UK public sector

Kong helps government organisations:

1. **Secure Digital Services**: Implement strong authentication, authorisation, and encryption for APIs and micro-services.
...
5. **Modernise Infrastructure**: Support transition to cloud and micro-services architectures.
