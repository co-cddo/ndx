...
describe("integration scenarios", () => {
  ...
  describe("cdn.jsdelivr.net domain", () => {
    it("should match cdn.jsdelivr.net URLs", () => {
      expect(isAllowedDomain("https://cdn.jsdelivr.net/gh/co-cddo/cloudmaturity@main/image.png", ["cdn.jsdelivr.net"])).toBe(
        true,
      )
    })

    it("should extract correct extension from jsdelivr URLs", () => {
      expect(getExtensionFromUrl("https://cdn.jsdelivr.net/gh/co-cddo/cloudmaturity@main/src/assets/image.png")).toBe(".png")
    ...
    it("should filter jsdelivr images from mixed HTML", () => {
      ...
      const allowedImages = images.filter((img) =>
        isAllowedDomain(img.url, ["img.shields.io", "cdn.jsdelivr.net"]),
      )
