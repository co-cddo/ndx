...
export class NdxStaticStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const addOriginFunction = new lambdaNodejs.NodejsFunction(
      this,
      'AddCloudFrontOriginFunction',
      {
    ...
    addOriginFunction.addToRolePolicy(
      new iam.PolicyStatement({
        ...
        resources: [
          `arn:aws:cloudfront::${this.account}:distribution/${config.distributionId}`,
        ],
      })
    );
    ...
    const configureCacheBehavior = new cdk.CustomResource(
      this,
