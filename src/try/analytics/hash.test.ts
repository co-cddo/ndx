...
describe("hashEmail", () => {
  ...
  it("should hash an email address using SHA-256", async () => {
    ...
    const mockHashBuffer = new Uint8Array([
      0x97, 0x3d, 0xfe, 0x46, 0x39, 0x6e, 0xb5, 0xa2, 0x5c, 0x0e, 0x7e, 0x83, 0xb0, 0x3c, 0x9a, 0x04, 0x5f, 0x27, 0x8a,
      0x96, 0x10, 0x17, 0x5b, 0x59, 0x12, 0x4a, 0x65, 0xe3, 0x6d, 0x87, 0xb7, 0x48,
    ])
  ...
  it("should produce consistent output for the same input", async () => {
    const mockHashBuffer = new Uint8Array([
      0xab, 0xcd, 0xef, 0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef, 0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef,
