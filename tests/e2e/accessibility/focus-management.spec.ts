  ...
  test.describe("Visual Focus Indicators", () => {
    test("Links have visible focus ring", async ({ page }) => {
      ...
      if ((await link.count()) > 0) {
        ...
        const hasFocusIndicator = focusStyles.outlineWidth !== "0px" || focusStyles.boxShadow !== "none"
    ...
    test("Buttons have visible focus ring", async ({ page }) => {
      ...
      if ((await button.count()) > 0) {
        ...
        const hasFocusIndicator = focusStyles.boxShadow !== "none" || focusStyles.outline !== "0px none rgb(0, 0, 0)"
        ...
        if ((await modal.count()) > 0) {
          ...
          if ((await checkbox.count()) > 0) {
            ...
            const hasFocusIndicator =
              focusStyles.boxShadow !== "none" || focusStyles.outline !== "0px none rgb(0, 0, 0)"
