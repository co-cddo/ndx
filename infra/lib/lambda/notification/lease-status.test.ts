...
describe('getStatusCategory', () => {
  ...
  it.each([
    ...
    'AccountQuarantined',
    'Ejected',
  ])('should return "terminal" for %s', (status) => {
...
describe('getExpectedFieldsForStatus', () => {
  ...
  it.each(['Active', 'Frozen'])(
    'should return base + monitored fields for %s',
    (status) => {
  ...
  it.each([
    ...
    'AccountQuarantined',
    'Ejected',
  ])('should return base + monitored + terminal fields for %s', (status) => {
    const fields = getExpectedFieldsForStatus(status);
