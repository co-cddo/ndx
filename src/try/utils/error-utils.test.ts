  ...
  describe("getHttpErrorMessage", () => {
    describe("default messages", () => {
      ...
      it("should return unavailable message for 500", () => {
        expect(getHttpErrorMessage(500)).toBe("The sandbox service is temporarily unavailable. Please try again later.")
      })

      it("should return unavailable message for 502", () => {
        expect(getHttpErrorMessage(502)).toBe("The sandbox service is temporarily unavailable. Please try again later.")
      })

      it("should return unavailable message for 503", () => {
        expect(getHttpErrorMessage(503)).toBe("The sandbox service is temporarily unavailable. Please try again later.")
      })

      it("should return unavailable message for 504", () => {
        expect(getHttpErrorMessage(504)).toBe("The sandbox service is temporarily unavailable. Please try again later.")
      })
    ...
    describe("context-specific messages", () => {
      ...
      it("should return configurations-specific message for 404", () => {
        expect(getHttpErrorMessage(404, "configurations")).toBe("Configuration not found. Please contact support.")
      })

      it("should return sessions-specific message for 403", () => {
        expect(getHttpErrorMessage(403, "sessions")).toBe("You do not have permission to view sessions.")
      })
