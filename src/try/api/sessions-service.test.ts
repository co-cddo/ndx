  ...
  describe('fetchUserLeases', () => {
    ...
    describe('Success scenarios', () => {
      ...
      it('should sort leases by createdAt descending (newest first)', async () => {
        const olderLease = { ...mockRawLease, leaseId: 'older', meta: { ...mockRawLease.meta, createdTime: '2025-01-01T00:00:00Z' } };
        const newerLease = { ...mockRawLease, leaseId: 'newer', meta: { ...mockRawLease.meta, createdTime: '2025-01-15T00:00:00Z' } };
