...
| AC2 | AUP displayed in scrollable container    | IMPLEMENTED | `src/try/ui/components/aup-modal.ts:278-279` - aup-modal\_\_aup-container with aupContent.textContent set to result.data.aup (line 125)                   |
