...
- **Heading Hierarchy:**
  ```html
  <!-- /try page structure -->
  <h1>Your Try Sessions</h1> <!-- Page title -->

  <h2>Active Sessions</h2> <!-- Section heading -->
  <!-- Active sessions table -->

  <h2>Past Sessions</h2> <!-- Section heading -->
  <!-- Past sessions table -->
  ```
  ```html
  <!-- Product page structure -->
  <h1>AWS Lambda</h1> <!-- Product title -->

  <h2>Overview</h2> <!-- Section -->
  <p>Product description...</p>

  <h2>Try Before You Buy</h2> <!-- Try feature section -->
